...
(function themes() {
    ...
    // Keep only the two supported themes visible in the selector.
    ...
    const darkButton = document.getElementById('mdbook-theme-navy');
    if (darkButton) {
        darkButton.id = 'mdbook-theme-dark';
    ...
    function get_theme() {
        ...
        if (theme === null || theme === undefined || !themeIds.includes('mdbook-theme-' + theme)) {
            if (typeof default_dark_theme === 'undefined') {
                ...
                return default_theme === 'navy' ? 'dark' : default_theme;
            }
            const fallback = window.matchMedia('(prefers-color-scheme: dark)').matches
                ? default_dark_theme
                : default_light_theme;
            return fallback === 'navy' ? 'dark' : fallback;
        } else {
            return theme === 'navy' ? 'dark' : theme;
        }
    }
